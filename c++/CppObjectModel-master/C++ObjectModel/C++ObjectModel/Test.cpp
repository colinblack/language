...
void test_multip_vitrual_inherit()
{
	...
	cout << "推测数据成员iBase地址：\t" << ((int*)(&dvi1) + 3) << "\t通过地址取得的值：" << *((int*)(&dvi1) + 3) << endl;

	cout << "虚函数表_vptr_inherit2地址：\t" << ((int*)(&dvi1) +4) << endl;
	cout << "_vptr_inherit2 — 第1个函数地址：\t" << (int*)*((int*)(&dvi1) +4) << endl;
	pFun = (Fun)*((int*)*((int*)(&dvi1) +4));
	pFun();
	cout << endl;
	cout << "_vptr_inherit2 — 第2个函数地址：\t" << (int*)*((int*)(&dvi1) +4) + 1 <<"\t通过地址取得的值：" << *((int*)*((int*)(&dvi1) +4) + 1) << "【结束】\t" << endl;
	cout << endl;
	cout << "======指向=============：\t" << ((int*)(&dvi1) +5) << "\t通过地址取得的值：" << (int*)*((int*)(&dvi1) +5) << "\t" <<*(int*)*((int*)(&dvi1) +5)<< endl;
	cout << "推测数据成员iInherit2地址：\t" << ((int*)(&dvi1) +6) << "\t通过地址取得的值：" << *((int*)(&dvi1) +6) << endl;
	cout << "推测数据成员iBase地址：\t" << ((int*)(&dvi1) +7) << "\t通过地址取得的值：" << *((int*)(&dvi1) +7) << endl;
	cout << "推测数据成员iDerived地址：\t" << ((int*)(&dvi1) +8) << "\t通过地址取得的值：" << *((int*)(&dvi1) +8) << endl;
	
	cout << "=======================： \t" << ((int*)(&dvi1) + 9) << endl;

	cout << "虚函数表_vptr_Base地址：\t" << ((int*)(&dvi1) +11) <<  endl;
	
	cout << "_vptr_Base — 第1个函数地址：\t" << (int*)*((int*)(&dvi1) +11) << "\t即析构函数地址" << endl;
	cout << "_vptr_Base — 第2个函数地址：\t" << ((int*)*((int*)(&dvi1) +11) +1) << "\t";

	pFun = (Fun)*((int*)*((int*)(&dvi1) +11) +1);
	pFun();
	cout << endl;
	cout << "_vptr_Base — 第3个函数地址：\t" << ((int*)*((int*)(&dvi1) +11) +2) << "【结束】\t" << *((int*)*((int*)(&dvi1) +11) +2);
	cout << endl;
	cout << "推测数据成员iBase地址：\t\t" << ((int*)(&dvi1) +12) << "\t通过地址取得的值：" << *((int*)(&dvi1) +12) << endl;
}
